...
# --- Logging Setup ---
log_path = Path("logs/import_contacts_bulk.log")
...
def row_to_sf_record(row: dict) -> dict:
    ...
    record = {
        ...
        "RecordTypeId":                     "012UD000003PdZ7YAK",
        ...
        "PersonEmail":                      dev_email(row.get("email")),
...
def main():
    ...
    accounts = db.fetch_all("SELECT * FROM int_crm_person_accounts")
