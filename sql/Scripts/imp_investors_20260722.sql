...
select * 
from  stg_imp_investors_formated_20260722
where external_id in ('ec56c3c4-8c45-4f66-8daa-9b0a095790e7')
...
inner join stg_imp_investors_formated_20260722 i
...
from stg_imp_investors_formated_20260722  i
...
where data_issue = 0
and external_id in (
'0eb68725-3b99-4204-837d-fe2118a610ab', -- abweichender name
'2c72cc49-beba-46c1-a114-fa5f48a0178d', -- abweichender name
'3275dcb7-ab56-48de-9a18-b20d4c6f2404', -- abweichender name
'73db78b3-5ce8-4e56-8ced-e3e388fcd2ed', -- abweichender name
'862099cd-20c8-48de-905e-fc80a6a40ce9', -- abweichender name
'96980cb6-8721-48e3-9f6e-6d3c39870eaf', -- abweichender name
'e824937a-b3b1-4e93-9adb-8e1ca1d46cf1', -- abweichender name
'f35bc021-b45d-4dec-8f59-435b476fd226', -- abweichender name
'7a82f52c-cedc-482d-9536-362f3db6da2e' -- abweichende externe id 
)
...
inner join stg_imp_investors_formated_20260722 inv
...
CALL sp_archive_crm_imp_person_accounts(
    '2026-07-22_update_invest_status_1',
    'oleg.danilov')
...
SELECT distinct
    ...
    null												AS loyalty_points_balance
-- select inv.*
FROM stg_imp_investors_formated_20260722 inv
