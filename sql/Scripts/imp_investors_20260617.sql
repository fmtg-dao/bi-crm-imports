...
select * from  stg_imp_investors_formated

ALTER TABLE stg_imp_investors_formated
ADD COLUMN investment_expiration_date_corrected DATE;

UPDATE stg_imp_investors_formated
...
select * from stg_imp_investors_formated where info <> 'bestand'
select count(*) from stg_imp_investors_formated where info = 'neu'
...
inner join stg_imp_investors_formated i
...
from stg_imp_investors_formated  i
...
inner join stg_imp_investors_formated inv
