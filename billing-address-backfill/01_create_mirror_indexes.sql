...
-- Same file as invest-consent/01_create_mirror_indexes.sql on the
-- invest-consent branch (PR #4; not merged into this branch yet). Only
-- idx_acc_id is strictly needed here, the rest keep the mirrors queryable.
